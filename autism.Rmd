...
lm_mABCTot = lm(SRS_TotalRawScore ~ mABC_TotalStandardScore, data = full_dat_autism)
lm_version = lm(SRS_TotalRawScore ~ mABC_TotalStandardScore + SRS_VERSION, data = full_dat_autism)
```
...
```{r warning=FALSE, message=FALSE}
lm_adhd = lm(SRS_TotalRawScore ~ mABC_TotalStandardScore*ADHD_Subtype + SRS_VERSION, data = full_dat_autism)
summary(lm_adhd)
...
```{r warning=FALSE, message=FALSE}
lm_gender_age = lm(SRS_TotalRawScore ~ mABC_TotalStandardScore*ADHD_Subtype + SRS_VERSION + Gender + SRS_AGE, data = full_dat_autism)
summary(lm_gender_age)
anova(lm_adhd, lm_gender_age)
```
