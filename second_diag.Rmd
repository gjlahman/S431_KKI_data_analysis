...
X.autism=X.autism[!is.na(P) & P!='Unknown' & P!='']
Y.autism=Y.autism[!is.na(P) & P!='Unknown' & P!='']
X.ADHD=X.ADHD[!is.na(P) & P!='Unknown' & P!='']
Y.ADHD=Y.ADHD[!is.na(P) & P!='Unknown' & P!='']
X.None=X.None[!is.na(P) & P!='Unknown' & P!='']
Y.None=Y.None[!is.na(P) & P!='Unknown' & P!='']
P=P[!is.na(P) & P!='Unknown' & P!='']
```
